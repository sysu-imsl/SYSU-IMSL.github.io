function onClick(arg) {
    ...
    if (data_ == "Objects") {
        ...
        json_path = 'https://github.com/sysu-imsl/SketchyCOCO/blob/master/data/Object.json'
    } else {
        sketch_path = 'data/Scene/Sketch/';
        gt_path = 'data/Scene/GT/';
        json_path = 'https://github.com/sysu-imsl/SketchyCOCO/blob/master/data/Scene.json'
    }
    ...
    //     q: 'select * from json where url="https://github.com/sysu-imsl/SketchyCOCO/blob/master/data/Scene.json"',
